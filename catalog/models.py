...
class Genre(models.Model):
    ...
    #String for representing our model object
    def __str__(self):
        return self.name
...
class Book(models.Model):
    ...
    # Foreign key used because a book can only have one author, but author can have multiple books (In this project)
    #and the same to language
